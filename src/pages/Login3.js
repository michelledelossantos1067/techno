...
function Login(props) {
    ...
    return (
        <div className="login card  bg-light w-25 p-5 container-fluid ">
            ...
            <a href="https://docs.google.com/spreadsheets/d/1Ynx282W0Y_LG6QVvRSM2ethvVbPGtppFT7pJRGdjy-U/edit#gid=0"><button type="button" value="Enviar" class="w-100 p-lg-2 text-light h5 border-1 bg-success rounded-2 mb-3">Entrar</button></a>
