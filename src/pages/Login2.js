...
function Login(props) {
    ...
    return (
        <div className="login card  bg-light w-25 p-5 container-fluid ">
            ...
            <a href="https://docs.google.com/spreadsheets/d/1MxgVJ9m235ItrU17bXPDEeZfWqE2_39t5HKelA4Jm_o/edit#gid=0"><button type="button" value="Enviar" class="w-100 p-lg-2 text-light h5 border-1 bg-success rounded-2 mb-3">Entrar</button></a>
